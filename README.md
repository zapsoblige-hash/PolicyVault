...
| Surface | Status |
|---|---|
| **Web / Agent platform** | **PRODUCTION — LIVE** at https://app.policy-vault.org. This release's build is `fullscale-rc31` (buildId `ec80d60`, image `sha256:cae6b7e7cb073a17b7f9dc0dd54288556e13c6157f08a1712e91624e0878fc32`); the served `/api/v1/health` `buildId` is authoritative for which build is active at any moment (`ec80d60` = this release; `9dbc5f7` = the preceding rc30 build of this same source line, live since 2026-09-09 06:01 UTC). You can also fully self-host |
| Current production source | **PUBLIC — this repository, v1.9.3** (exact identity chain in `PUBLIC_RELEASE_MANIFEST.md`; v1.9.2 and v1.9.1 remain published unchanged; the prepared candidates v1.6.0 / v1.7.0 / v1.8.0 / v1.9.0 were never published separately and are included) |
